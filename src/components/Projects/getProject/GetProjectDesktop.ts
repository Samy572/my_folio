export const GetProjectDesktop = () => [
	{
		id: 1,
		label: 'Crazy-Burger',
		png: '/asset/images/projects/crazy-burger.png',
		description:
			'A crud application for adding, modifying, deleting and reading data',
		path: 'https://burger-shop-cyan.vercel.app/',
		language: [
			{
				label: 'React',
				svg: 'asset/svg/frontend/react.svg',
				alt: 'react',
				path: 'https://reactjs.org/',
				className:
					' lg:inline-flex items-center justify-between rounded-md border w-fit px-2 py-0.5  font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-none  shadow bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-700 hover:to-purple-700 md:mr-4 mr-2 my-2 ',
			},
			{
				label: 'Styled-Components',
				svg: 'asset/svg/frontend/styled.svg',
	...
	},
	{
		...
		language: [
			{
				label: 'Tailwind',
				svg: 'asset/svg/frontend/tailwind.svg',
				alt: 'tailwind',
...
// 	png: '/asset/svg/crypto.svg',
// 	description: 'Dashboard for tracking crypto currencies.',
// 	path: 'https://resplendent-unicorn-c94188.netlify.app',
// 	language: [
// 		{
// 			label: 'React',
// 			svg: 'asset/svg/frontend/react.svg',
...
// 		{
// 			label: 'SCSS',
// 			svg: 'asset/svg/frontend/scss.svg',
// 			alt: 'Sass',
...
// 		},
// 	],
// 	github: 'https://github.com/Samy572/Crypto-view',
// },